...
public class Main {
	...
	public static void main(String[] args) {
		...
		*/
		...
		instructor.setDateOfEmployment(null);
		...
		*/
		/*
		Hall hall = new Hall();
		hall.setName("Software Engineering");
        hall.setCode("SWE101");
        hall.setDepartment(Department.Electrical);
        hall.setCapacity(125);
        hall.setLocation("location");
        hall.setCategory("section room");
        if(factory.createHallDAO().insert(hall))
